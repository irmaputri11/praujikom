...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="{{ asset('assets/karl/img/core-img/irma.png')}}">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <option value="ger">jawa timur</option>
                                        <option value="fra">DKI jakarta</option>
                                        <option value="ind">Jambi</option> 
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="postcode">kode post <span>*</span></label>
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="phone_number">No Handphone <span>*</span></label>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>{{$data->nama_produk}}</span> <span>Rp {{$data->harga}}</span></li>
                                <td>
