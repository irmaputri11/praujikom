            ...
            <div class="menu-list">
                ...
                <ul id="menu-content" class="menu-content collapse out">
                    ...
                    <li data-toggle="collapse" data-target="#women" class="collapsed active">
                        <a href="#">masker wajah <span class="arrow"></span></a>
                        <ul class="sub-menu collapse" id="women">
                            <li><a href="#">pandan</a></li>
                            <li><a href="#">crochoal</a></li>
                            <li><a href="#">vanila</a></li>
                            <li><a href="#">greantee</a></li>
                        </ul>
                    </li>
                    <!-- Single Item -->
                            ...
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <a href="#" class="image"><img src="{{ asset('assets/karl/img/product-img/product-10.jp')}}g" class="cart-thumb" alt=""></a>
                                            ...
                                            <li>
                                                <a href="#" class="image"><img src="{{ asset('assets/karl/img/product-img/product-11.jp')}}g" class="cart-thumb" alt=""></a>
                                                <div class="cart-item-desc">
                                                    <h6><a href="#">Women's Fashion</a></h6>
                                                    <p>1x - <span class="price">$10</span></p>
                                                </div>
