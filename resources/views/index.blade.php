...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="{{ asset('assets/kal/img/core-img/favicon.ico')}}">
                ...
                <div class="container h-100">
                    <div class="row h-100">
                        <div class="col-12 d-md-flex justify-content-between">
                            ...
                            <!-- Help Line -->
                            <div class="help-line">
                                <a href="tel:+6232"><i class="ti-headphone-alt"></i> +34 657 3556 778</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="{{ $i++ }}s">
