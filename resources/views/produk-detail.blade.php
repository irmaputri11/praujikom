...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/karl/style.css')}}">
                            ...
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <a href="#" class="image"><img src="{{ asset('assets/karl/img/product-img/product-10.jpg')}}" class="cart-thumb" alt=""></a>
                                            ...
                                            <li>
                                                <a href="#" class="image"><img src="{{ asset('assets/karl/img/product-img/product-11.jpg')}}" class="cart-thumb" alt=""></a>
                                                <div class="cart-item-desc">
                                                    <h6><a href="#">Women's Fashion</a></h6>
                                                    <p>1x - <span class="price">$10</span></p>
                                                </div>
...
<!-- 
                                <ol class="carousel-indicators">
                                    ...
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url({{ asset('assets/karl/img/product-img/product-2.jpg')}});">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url({{ asset('assets/karl/img/product-img/product-3.jpg')}});">
                                    </li>
                    ...
                    <div class="col-12">
                        <div class="you_make_like_slider owl-carousel">
                            ...
                            <div class="single_gallery_item">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="{{ asset('assets/karl/img/product-img/product-2.jpg')}}" alt="">
                                    <div class="product-quicview">
                                        <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                                    </div>
                                </div>
